        ...
        <div class="second">
            <form action="#" method="get">
                ...
                <select name="select_option" id="craft">
                    ...
                    <option value="lesser_life_pot">Lesser Healing Potion</option>
                    <option value="greater_life_pot">Greater Healing Potion</option>
                </select>
            ...
            if (array_key_exists("submit_lesser_healing_pot", $_GET)) {
                if_lesser_healing_pot();
            }
            if (array_key_exists("submit_greater_healing_pot", $_GET)) {
                if_greater_healing_pot();
            }
