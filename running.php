        ...
        <div class="second">
            <form action="#" method="get">
                ...
                <select name="select_option" id="craft">
                    ...
                    <option value="lesser_life_pot">Lesser Running Scroll</option>
                    <option value="life_pot">Common Running Scroll</option>
                    <option value="greater_life_pot">Greater Running Scroll</option>
                </select>
            ...
            if (array_key_exists("submit_lesser_running_scroll", $_GET)) {
                if_lesser_running_scroll();
            }
            if (array_key_exists("submit_common_running_scroll", $_GET)) {
                if_common_running_scroll();
            }
            if (array_key_exists("submit_greater_running_scroll", $_GET)) {
                if_greater_running_scroll();
            }
