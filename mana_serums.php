...
require("./crafts/mana_serums.php");
        ...
        <div class="second">
            <form action="#" method="get">
                ...
                <select name="select_option" id="craft">
                    ...
                    <option value="lesser_life_pot">Lesser Mana Serum</option>
                    <option value="life_pot">Mana Serum</option>
                    <option value="greater_life_pot">Greater Mana Serum</option>
                    <option value="major_life_pot">Major Mana Serum</option>
                    <option value="superior_life_serum">Super Mana Serum</option>
                </select>
