        ...
        <div class="second">
            <form action="#" method="get">
                ...
                <select name="select_option" id="craft">
                    ...
                    <option value="lesser_life_pot">Lesser Life Potion</option>
                    <option value="life_pot">Life Potion</option>
                    <option value="greater_life_pot">Greater Life Potion</option>
                    <option value="major_life_pot">Major Life Potion</option>
                </select>
            ...
            if (isset($selectedCraft)) {
                ...
                if ($selectedCraft == "major_life_pot") {
                    major_life_potion_view();
                }

            }

            //toto se zobrazí, pokud si uživatel vybral možnost, co craftovat a vyplnil formulář craftu
            if (array_key_exists("submit_lesser_life_pot", $_GET)) {
                if_lesser_life_pot();
            }
            if (array_key_exists("submit_life_pot", $_GET)) {
                if_life_pot();
            }
            if (array_key_exists("submit_greater_life_pot", $_GET)) {
                if_greater_life_pot();
            }
            if (array_key_exists("submit_major_life_pot", $_GET)) {
                if_major_life_pot();
            }
